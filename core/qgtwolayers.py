...
class TwoLayerQG(Param):
    ...
    def __init__(self,param,grid):
        ...
        # for variables
        param.varname_list=('pv1','psi1','u1','v1','pv2','psi2','u2','v2')
...
#        self.kt +=1
    ...
    def add_backgroundpv(self):
        self.var.state[self.ipv1][:,:] = self.var.state[self.ipv1] + self.pvback
        self.var.state[self.ipv2][:,:] = self.var.state[self.ipv2] + self.pvback
