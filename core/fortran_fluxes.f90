!----------------------------------------
  subroutine adv_upwind(msk,x,y,u,v,xflx,yflx,cst,nh,method,order,m,n)
    ...
    real*8,dimension(m,n) :: x,y,u,v,xflx,yflx
    real*8,dimension(5):: cst

!f2py intent(inplace)::msk,x,y,u,v,xflx,yflx
...
!----------------------------------------
  subroutine adv_centered(msk,x,y,u,v,xflx,yflx,cst,nh,method,order,m,n)
